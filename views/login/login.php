...
<html>
    <head>
        ...
        <link rel="stylesheet" href="views/assets/font-awesome-4.0.3/css/font-awesome.min.css">
        <link rel="stylesheet" href="views/assets/css/social-buttons.css">	
		    ...
		    <div class="row">
				<div class="col-md-4 col-md-offset-4">
		    		<div class="panel panel-default">
					    ...
					    <form>
					    	<input id="login" class="btn btn-block col-md-5 soc_but" type="submit" value="Linkedin">
					    	<input id="login" class="btn col-md-5 btn-block soc_but" type="submit" value="Twitter">
					    	<input id="login" class="btn col-md-5 btn-block soc_but" type="submit" value="Google">
					    	<input id="login" class="btn col-md-5 btn-block soc_but" type="submit" value="Facebook">
					    </form>
					    </div>
					</div>
				</div>
